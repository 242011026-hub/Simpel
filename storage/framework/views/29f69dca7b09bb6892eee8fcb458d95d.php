...
unset($__errorArgs, $__bag); ?>
                        ...
                        <p class="text-center small mb-0">Sudah terdaftar sebelumnya? <a href="<?php echo e(route('login')); ?>">Masuk disini</a></p>
                    </form>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\LAB\Herd\Simpel\resources\views/auth/register.blade.php ENDPATH**/ ?>